...
class HotelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hotel" do
    assert_difference("Hotel.count") do
      post hotels_url, params: { hotel: { location: @hotel.location, name: @hotel.name, owner: @hotel.owner, status: @hotel.status } }
    end
  ...
  test "should update hotel" do
    patch hotel_url(@hotel), params: { hotel: { location: @hotel.location, name: @hotel.name, owner: @hotel.owner, status: @hotel.status } }
