...
class RoomCategoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create room_category" do
    assert_difference("RoomCategory.count") do
      post room_categories_url, params: { room_category: { capacity: @room_category.capacity, facilities: @room_category.facilities, name: @room_category.name, price: @room_category.price } }
    end
  ...
  test "should update room_category" do
    patch room_category_url(@room_category), params: { room_category: { capacity: @room_category.capacity, facilities: @room_category.facilities, name: @room_category.name, price: @room_category.price } }
